...
int exec() {
  int cont = 1;
  int addr, val;
  void* jumptable[] = {&&L0, &&L1, &&L2, &&L3, &&L4, &&def, &&L6, &&L7, &&L8, &&L9, &&L10, &&L11, &&L12,
                    &&L13, &&L14, &&L15, &&end};
  void* jumptableL6[] = {&&L6_0, &&L6_1, &&L6_2, &&L6_3, &&L6_4, &&L6_5, &&L6_6, &&L6_7, &&L6_default, 
                      &&L6_default, &&L6_default, &&L6_default, &&L6_default, &&L6_default, &&L6_default, &&L6_15};

    if(insOpCode > 0xf || insOpCode < 0)
        goto def;
    else
    ...
    L4: 
        ...
        goto end;
    L6:
        if(insOp0 > 0xf || insOp0 < 0)
            goto def;
        else
            goto * jumptableL6[insOp0];
